			...
			\subsection{Opis tablica}
				...
				\subsubsection{DjelatnikGrupa}
					...
					\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
						...
						\hline \multicolumn{3}{|c|}{\textbf{DjelatnikGrupa}}	 \\[3pt] \hline
						\endfirsthead
				...
				\subsubsection{DjelatnikZadatak}
					...
					\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
						...
						\hline \multicolumn{3}{|c|}{\textbf{DjelatnikZadatak}}	 \\[3pt] \hline
						\endfirsthead
				...
				\subsubsection{UnosRadnihSati}
					...
					\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
						...
						\cellcolor{LightBlue}idZadatak & INTEGER & Identifikator zadatka na kojeg se unos odnosi. \\
